...
!function(n) {
    ...
    function c(e, t, n, r) {
        var a = typeof e
          , o = "string" == a;
        return "number" == a || "bigint" == a || !(!r || !_(e)) || (t && o && (e = E(e, t)),
        n && o && (e = e.replace(P, "")),
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                    ...
                    for (g = w.length - 1; 0 <= g; g--) {
                        ...
                        b = L.length; v < b; v++) {
                            ...
                            if ("number" == typeof A && 0 <= A) {
                                ...
                                for (y = 0,
                                D = I.length; y < D; y++)
                                    "_all" === A ? C(y, x) : -1 !== A.indexOf(":name") ? I[y].sName === A.replace(":name", "") && C(y, x) : _.forEach(function(e) {
                                        e[y] && (e = H(e[y].cell),
                                        A.match(/^[a-z][\w-]*$/i) && (A = "." + A),
                                        e.is(A)) && C(y, x)
                                    })
                ...
                var n = a.children("caption")
                  , n = (c.caption && (n = 0 === n.length ? H("<caption/>").appendTo(a) : n).html(c.caption),
    ...
    {}), N = /[\r\n\u2028]/g, F = /<([^>]*>)/g, O = Math.pow(2, 28), j = /^\d{2,4}[./-]\d{1,2}[./-]\d{1,2}([T ]{1}\d{1,2}[:.]\d{2}([.:]\d{2})?)?$/, R = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")","g"), P = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, _ = function(e) {
        return !e || !0 === e || "-" === e
    }, E = function(e, t) {
        return d[t] || (d[t] = new RegExp(Ee(t),"g")),
        "string" == typeof e && "." !== t ? e.replace(/\./g, "").replace(d[t], ".") : e
    }, b = function(e, t, n) {
        var r = []
          , a = 0
          , o = e.length;
    ...
    function ne(e) {
        !function(t) {
            if (t.oFeatures.bAutoWidth) {
                var e, n, r = t.nTable, a = t.aoColumns, o = t.oScroll, i = o.sY, l = o.sX, o = o.sXInner, s = ie(t, "bVisible"), u = r.getAttribute("width"), c = r.parentNode, d = r.style.width, f = ze(t);
                if (f === t.containerWidth)
                    return;
                t.containerWidth = f,
                d || u || (r.style.width = "100%",
                d = "100%"),
                d && -1 !== d.indexOf("%") && (u = d),
                ...
                var v, b, d = H("<div/>").css(l || i ? {
                    ...
                    right: 0,
                    overflow: "hidden"
                } : {}).append(f).appendTo(c), y = (l && o ? f.width(o) : l ? (f.css("width", "auto"),
                f.removeAttr("width"),
                f.outerWidth() < c.clientWidth && u && f.outerWidth(c.clientWidth)) : i ? f.outerWidth(c.clientWidth) : u && f.outerWidth(u),
                0), D = f.find("tbody tr").eq(0).children();
                ...
                d.remove(),
                u && (r.style.width = L(u)),
                !u && !l || t._reszEvt || (v = V.util.throttle(function() {
                    var e = ze(t);
                    t.bDestroying || 0 === e || ne(t)
                }),
                W.ResizeObserver ? (b = H(t.nTableWrapper).is(":visible"),
                o = H("<div>").css({
                    width: "100%",
                    height: 0
                ...
                t.resizeObserver.observe(o[0])) : H(W).on("resize.DT-" + t.sInstance, v),
                t._reszEvt = !0)
            }
        }(e);
    ...
    function be(e, t, n, r) {
        ...
        "dom" !== n && (n && "auto" !== n || "dom" !== i.src)) {
            ...
            i._aData = ye(e, i, r, void 0 === r ? void 0 : i._aData).data;
        var u = e.aoColumns;
        if (void 0 !== r)
            u[r].sType = null,
    ...
    function xe(e, t, n, r) {
        ...
        if (null === c.nTr) {
            ...
            s = e.aoColumns.length; l < s; l++) {
                i = e.aoColumns[l],
                (o = (u = !n || !r[l]) ? S.createElement(i.sCellType) : r[l]) || z(e, 0, "Incorrect column count", 18),
                o._DT_CellIndex = {
                    row: t,
                    column: l
                },
    ...
    function x(e, t) {
        ...
        -1 !== G(e, "aoPreDrawCallback", "preDraw", [e]).indexOf(!1))
            ...
            e.deferLoading)
                ...
                if (!e.bDestroying && !t)
                    return 0 === e.iDraw && c.empty().append(Ie(e)),
                    (l = e).iDraw++,
                    I(l, !0),
            ...
            if (0 !== o.length)
                ...
                n[0] = Ie(e);
            G(e, "aoHeaderCallback", "header", [H(e.nTHead).children("tr")[0], me(e), i, s, o]),
            G(e, "aoFooterCallback", "footer", [H(e.nTFoot).children("tr")[0], me(e), i, s, o]),
    ...
    function Le(e, t, a) {
        ...
        for (var n = 0; n < o.length; n++)
            ...
            !function(o, i) {
                function l(e, t) {
                    return T.features[e] || z(o, 0, "Unknown feature: " + e),
    ...
    function Ae(t) {
        var r, e = t.oClasses, n = H(t.nTable), a = H("<div/>").attr({
            id: t.sTableId + "_wrapper",
            class: e.container
        }).insertBefore(n);
        if (t.nTableWrapper = a[0],
        t.sDom)
            for (var o, i, l, s, u, c, d = t, e = t.sDom, f = a, h = e.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++)
                o = null,
                "<" == (i = h[p]) ? (l = H("<div/>"),
        ...
        g = c.length; p < g; p++)
            for (a = (r = c[p]).firstChild; a; ) {
                if ("TD" == a.nodeName.toUpperCase() || "TH" == a.nodeName.toUpperCase()) {
                    ...
                    !m.sTitle && s && (m.sTitle = w(a.innerHTML),
                    ...
                    0 === H("span.dt-column-title", a).length && H("<span>").addClass("dt-column-title").append(a.childNodes).appendTo(a),
                    e.orderIndicators && f && 0 !== S.filter(":not([data-dt-order=disable])").length && 0 !== S.parent(":not([data-dt-order=disable])").length && 0 === H("span.dt-column-order", a).length && H("<span>").addClass("dt-column-order").appendTo(a),
                    0 === H("span.dt-column-" + (b = f ? "header" : "footer"), a).length) && H("<div>").addClass("dt-column-" + b).append(a.childNodes).appendTo(a),
                    i = 0; i < y; i++) {
                        for (o = 0; o < D; o++)
                            h[p + o][l + i] = {
                                cell: a,
    ...
    function Fe(n, e, r) {
        function t(e) {
            ...
            if ((null === e || "number" == typeof t && 204 == t) && Oe(n, e = {}, []),
        ...
        "function" == typeof o ? n.jqXHR = o.call(i, e, t, n) : "" === o.url ? (Oe(n, i = {}, []),
            ...
            for (var r, a, o, i, l, s = n, u = s.aoColumns, c = s.aoData, d = 0; d < c.length; d++)
                if (c[d] && !(l = c[d])._aFilterData) {
                    ...
                    a = u.length; r < a; r++)
                        ...
                        i.indexOf && -1 !== i.indexOf("&") && (ke.innerHTML = i,
    ...
    function Pe(e, t, n, r, a) {
        if ("" !== n) {
            for (var o = 0, i = [], l = "function" == typeof n ? n : null, s = n instanceof RegExp ? n : l ? null : function(e, t) {
                ...
                if (e = k(e),
                t.exact)
                    return new RegExp("^" + Ee(e) + "$",t.caseInsensitive ? "i" : "");
                {
                    var n, a, o;
                    e = t.regex ? e : Ee(e),
    ...
    function He(i) {
        ...
        n = function() {
            ...
            e.orderHandler && Ye(e, t, t === e.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o),
            g(e, r = [], e.aaSorting),
            e.aaSorting = r,
            $e(i),
            I(i, !0),
    ...
    function Ye(o, e, t, i, l) {
        nt(e, t, function(e) {
            var t = !1
              , n = void 0 === i ? de(e.target) : "function" == typeof i ? i() : Array.isArray(i) ? i : [i];
            if (n.length) {
                for (var r = 0, a = n.length; r < a; r++)
                    if (!1 !== function(e, t, n, r) {
                        ...
                        (r || n) && e.oFeatures.bSortMulti ? -1 !== (i = b(l, "0").indexOf(t)) ? null === (o = null === (o = a(l[i], !0)) && 1 === l.length ? 0 : o) ? l.splice(i, 1) : (l[i][1] = s[o],
    ...
    function Ze(e, t, n) {
        ...
        a = c.length; r < a; r++) {
            ...
            for (var D = V.ext.type.order[b.sType + "-pre"], x = m.aoData, S = 0; S < x.length; S++)
                x[S] && ((p = x[S])._aSortData || (p._aSortData = []),
                p._aSortData[v] && !y || (g = y ? h[S] : q(m, S, v, "sort"),
    ...
    function et(r, e, t) {
        ...
        if (e && e.time) {
            ...
            if (0 < s && e.time < +new Date - 1e3 * s)
                ...
                r.iInitDisplayStart = e.start) : Ve(r, e.start / r._iDisplayLength)),
    ...
    X.extend = function(e, t, n) {
        if (n.length && t && (t instanceof X || t.__dt_wrapper))
            for (var r, a = 0, o = n.length; a < o; a++)
                "__proto__" !== (r = n[a]).name && (t[r.name] = "function" === r.type ? function(t, n, r) {
                    return function() {
    ...
    function mt(e, t) {
        ...
        if (n.length && e.length) {
            ...
            if (r._details) {
                (r._detailsShow = t) ? (r._details.insertAfter(r.nTr),
                H(r.nTr).addClass("dt-hasChild")) : (r._details.detach(),
    ...
    r("rows.add()", function(o) {
        var e = this.iterator("table", function(e) {
            for (var t, n = [], r = 0, a = o.length; r < a; r++)
                (t = o[r]).nodeName && "TR" === t.nodeName.toUpperCase() ? n.push(fe(e, t)[0]) : n.push(D(e, t));
            return n
        }, 1)
          , t = this.rows(-1);
        return t.pop(),
    ...
    function(e, t) {
        ...
        var n = this.context;
        return void 0 === e ? n.length && this.length && n[0].aoData[this[0]] ? n[0].aoData[this[0]]._details : void 0 : (!0 === e ? this.child.show() : !1 === e ? Tt(this) : n.length && this.length && gt(n[0], n[0].aoData[this[0]], e, t),
        this)
    }),
    ...
    r("columns()", function(n, r) {
        ...
        var e = this.iterator("table", function(e) {
            ...
            l.columnOrder && "index" === l.columnOrder ? t.sort(function(e, t) {
                return e - t
            }) : t;
            var i, t, l, s, u, c, d
        }, 1);
    ...
    r("column.index()", function(e, t) {
        ...
        if (0 !== this.context.length)
            ...
            "fromVisible" === e || "toData" === e ? re(n, t) : "fromData" === e || "toVisible" === e ? ae(n, t) : void 0
    }),
    ...
    function Lt(e, t) {
        ...
        H(e).find("span.dt-column-title").each(function() {
            var e = H(this).html();
    ...
    V.factory = function(e, t) {
        var n = !1;
        return e && e.document && (S = (W = e).document),
    ...
    function At(t, n) {
        return function(e) {
            return _(e) || "string" != typeof e || (e = e.replace(N, " "),
            t && (e = w(e)),
            n && (e = k(e, !1))),
            e
        }
    ...
    function Ot(e, t, n) {
        ...
        i = W.moment && !i ? W.moment : i) {
            ...
            t ? (Ft || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),
            Ft = !0) : r = new Date(e);
        return r
    }
    function jt(s) {
        return function(r, a, o, i) {
            ...
            function(e, t) {
                ...
                "type" === t ? l : "" === e ? "sort" !== t ? "" : Ot("0000-01-01 00:00:00", null, o) : !(null === a || r !== a || "sort" === t || "type" === t || e instanceof Date) || null === (n = Ot(e, r, o)) ? e : "sort" === t ? n : (e = null === a ? Nt(n, "toDate", "toJSDate", "")[s]() : Nt(n, "format", "toFormat", "toISOString", a),
                "display" === t ? u(e) : e)
            }
        }
    }
    ...
    if (void 0 !== W.Intl)
        try {
            for (var Et = (new Intl.NumberFormat).formatToParts(100000.1), l = 0; l < Et.length; l++)
                "group" === Et[l].type ? Rt = Et[l].value : "decimal" === Et[l].type && (Pt = Et[l].value)
        } catch (e) {}
    ...
    function(e, t, n, r) {
        var a;
        return 0 === e || e && "-" !== e ? "number" == (a = typeof e) || "bigint" == a ? e : +(e = (e = t ? E(e, t) : e).replace && (n && (e = e.replace(n, "")),
        r) ? e.replace(r, "") : e) : -1 / 0
    }
    );
    function Wt(e, t, n) {
    ...
    V.feature.register("div", function(e, t) {
        var n = H("<div>")[0];
        return t && (Wt(n, "className", t.className),
        Wt(n, "id", t.id),
    ...
    V.feature.register("search", function(n, r) {
        ...
        (s = H("<div>").addClass(e.container).append(l.replace(/_INPUT_/, o))).find("label").attr("for", "dt-search-" + Xt),
        ...
        function n() {
            !function e(t, n, r) {
                ...
                for (var p = 0; p < f.length; p++) {
                    var g = f[p]
                      , m = Bt(t, g, c, d)
                      , v = at(t, "pagingButton")(t, g, m.display, m.active, m.disabled)
    ...
    return V.feature.register("pageLength", function(r, e) {
        ...
        return c.find("label").attr("for", "dt-length-" + Ut),
...
!function(e) {
    ...
    "use strict";
    var B, c, a, d, l, h, p, e, i, D = s.fn.dataTable;
    function m() {
        var t = D.use("moment");
        return t || u.moment
    }
    ...
    function T(t, i, e, n, s, o, r) {
        void 0 === n && (n = 0),
        void 0 === s && (s = 1),
        void 0 === o && (o = void 0),
        void 0 === r && (r = !1);
        var a = this
          , i = (this.classes = B.extend(!0, {}, T.classes),
        this.c = B.extend(!0, {}, T.defaults, B.fn.dataTable.ext.searchBuilder, i),
        this.c.i18n);
        if (this.s = {
            condition: void 0,
            conditions: {},
        ...
        this.dom = {
            buttons: B("<div/>").addClass(this.classes.buttonContainer),
            condition: B("<select disabled/>").addClass(this.classes.condition).addClass(this.classes.dropDown).addClass(this.classes.italic).attr("autocomplete", "hacking"),
            conditionTitle: B('<option value="" disabled selected hidden/>').html(this.s.dt.i18n("searchBuilder.condition", i.condition)),
            container: B("<div/>").addClass(this.classes.container),
            data: B("<select/>").addClass(this.classes.data).addClass(this.classes.dropDown).addClass(this.classes.italic),
            dataTitle: B('<option value="" disabled selected hidden/>').html(this.s.dt.i18n("searchBuilder.data", i.data)),
            defaultValue: B("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.select).addClass(this.classes.italic),
            delete: B("<button/>").html(this.s.dt.i18n("searchBuilder.delete", i.delete)).addClass(this.classes.delete).addClass(this.classes.button).attr("title", this.s.dt.i18n("searchBuilder.deleteTitle", i.deleteTitle)).attr("type", "button"),
            inputCont: B("<div/>").addClass(this.classes.inputCont),
            left: B("<button/>").html(this.s.dt.i18n("searchBuilder.left", i.left)).addClass(this.classes.left).addClass(this.classes.button).attr("title", this.s.dt.i18n("searchBuilder.leftTitle", i.leftTitle)).attr("type", "button"),
            right: B("<button/>").html(this.s.dt.i18n("searchBuilder.right", i.right)).addClass(this.classes.right).addClass(this.classes.button).attr("title", this.s.dt.i18n("searchBuilder.rightTitle", i.rightTitle)).attr("type", "button"),
            value: [B("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select)],
            valueTitle: B('<option value="--valueTitle--" disabled selected hidden/>').html(this.s.dt.i18n("searchBuilder.value", i.value))
        },
        this.c.greyscale) {
        ...
        return B(u).on("resize.dtsb", c.util.throttle(function() {
    ...
    function n(t, i) {
        ...
        t = new h.Api(t);
        if (this.classes = l.extend(!0, {}, n.classes),
        this.c = l.extend(!0, {}, n.defaults, i),
        this.dom = {
            clearAll: l('<button type="button">' + t.i18n("searchBuilder.clearAll", this.c.i18n.clearAll) + "</button>").addClass(this.classes.clearAll).addClass(this.classes.button).attr("type", "button"),
    ...
    function o(t, i) {
        t = new D.Api(t),
        i = i || t.init().searchBuilder || D.defaults.searchBuilder;
        return new e(t,i).getNode()
    }
    return T._escapeHTML = function(t) {
    ...
    ,
    T.parseNumFmt = function(t) {
        return +t.replace(/(?!^-)[^0-9.]/g, "")
    }
    ,
    T.prototype.updateArrows = function(t) {
        void 0 === t && (t = !1),
        this.dom.container.children().detach(),
        this.dom.container.append(this.dom.data).append(this.dom.condition).append(this.dom.inputCont),
        this.setListeners(),
        void 0 !== this.dom.value[0] && B(this.dom.value[0]).trigger("dtsb-inserted");
        for (var i = 1; i < this.dom.value.length; i++)
            this.dom.inputCont.append(this.dom.value[i]),
            B(this.dom.value[i]).trigger("dtsb-inserted");
    ...
    T.prototype.search = function(t, i) {
        ...
        if (void 0 !== this.s.condition && void 0 !== n) {
            ...
            if (this.s.type && this.s.type.includes("num") && ("" !== e.oLanguage.sDecimal || "" !== e.oLanguage.sThousands)) {
    ...
    T.prototype.getDetails = function(t) {
        ...
        if (null === this.s.type || !["num", "num-fmt", "html-num", "html-num-fmt"].includes(this.s.type) || "" === e.oLanguage.sDecimal && "" === e.oLanguage.sThousands) {
            if (null !== this.s.type && t) {
                var n = m()
                  , s = f();
                if (this.s.type.includes("date") || this.s.type.includes("time"),
                this.s.type.includes("moment") || this.s.type.includes("datetime") && m)
                    for (i = 0; i < this.s.value.length; i++)
                        this.s.value[i] && 0 < this.s.value[i].length && n(this.s.value[i], this.s.dateFormat, !0).isValid() && (this.s.value[i] = n(this.s.value[i], this.s.dateFormat).format("YYYY-MM-DD HH:mm:ss"));
                else if (this.s.type.includes("luxon") || this.s.type.includes("datetime") && f)
                    for (i = 0; i < this.s.value.length; i++)
                        this.s.value[i] && 0 < this.s.value[i].length && null === s.DateTime.fromFormat(this.s.value[i], this.s.dateFormat).invalid && (this.s.value[i] = s.DateTime.fromFormat(this.s.value[i], this.s.dateFormat).toFormat("yyyy-MM-dd HH:mm:ss"))
            }
        } else
            for (i = 0; i < this.s.value.length; i++) {
                var o = [this.s.value[i].toString()];
                if ("" !== e.oLanguage.sDecimal && (o = this.s.value[i].split(e.oLanguage.sDecimal)),
                "" !== e.oLanguage.sThousands)
                    for (var r = 0; r < o.length; r++)
                        o[r] = o[r].replace(e.oLanguage.sThousands, ",");
                this.s.value[i] = o.join(".")
            }
    ...
    ,
    T.prototype.parseNumber = function(t) {
    ...
    T.prototype.rebuild = function(t) {
        ...
        this.dom.data.children("option").each(function() {
            !s && (B(this).text() === t.data || t.origData && B(this).prop("origData") === t.origData) ? (B(this).prop("selected", !0),
            n.removeClass(e),
            s = !0,
            i = parseInt(B(this).val(), 10)) : B(this).removeProp("selected")
        })),
        s) {
            this.s.data = t.data,
    ...
    ,
    T.prototype._buildCriteria = function() {
    ...
    ,
    T.prototype._clearCondition = function() {
    ...
    ,
    T.prototype._clearValue = function() {
        var t;
        if (void 0 !== this.s.condition) {
            ...
            if (this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, T.updateListener)),
            0 < this.dom.value.length && void 0 !== this.dom.value[0]) {
                ...
                B(this.dom.value[0]).trigger("dtsb-inserted");
                for (var n = 1; n < this.dom.value.length; n++)
                    this.dom.inputCont.append(this.dom.value[n]),
                    B(this.dom.value[n]).trigger("dtsb-inserted")
            }
        } else {
        ...
        this.s.value = [],
        this.dom.value = [B("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select).append(this.dom.valueTitle.clone())]
    }
    ,
    T.prototype._getOptions = function() {
        var t = this.s.dt;
        return B.extend(!0, {}, T.defaults, t.settings()[0].aoColumns[this.s.dataIdx].searchBuilder)
    }
    ,
    T.prototype._populateCondition = function() {
        var t = []
        ...
        if (0 === i) {
            ...
            void 0 !== n && (void 0 !== (r = n[s]).searchBuilderType && null !== r.searchBuilderType ? this.s.type = r.searchBuilderType : void 0 !== this.s.type && null !== this.s.type || (this.s.type = r.sType)),
            null !== this.s.type && void 0 !== this.s.type || (B.fn.dataTable.ext.oApi && B.fn.dataTable.ext.oApi._fnColumnTypes(e.settings()[0]),
            this.s.type = e.column(s).type()),
            ...
            var o, r = e.settings()[0].oLanguage.sDecimal, a = ("" !== r && this.s.type && this.s.type.indexOf(r) === this.s.type.length - r.length && (this.s.type.includes("num-fmt") || this.s.type.includes("num")) && (this.s.type = this.s.type.replace(r, "")),
            void 0);
            void 0 !== this.c.conditions[this.s.type] ? a = this.c.conditions[this.s.type] : this.s.type && "datetime" === this.s.type ? (r = D.use("moment"),
            o = D.use("luxon"),
            r && (a = this.c.conditions.moment,
            this.s.dateFormat = r().creationData().locale._longDateFormat.L),
            o && (a = this.c.conditions.luxon,
            this.s.dateFormat = o.DateTime.DATE_SHORT)) : this.s.type && this.s.type.includes("datetime-") ? (a = D.use("moment") ? this.c.conditions.moment : this.c.conditions.luxon,
            this.s.dateFormat = this.s.type.replace(/datetime-/g, "")) : this.s.type && this.s.type.includes("moment") ? (a = this.c.conditions.moment,
            this.s.dateFormat = this.s.type.replace(/moment-/g, "")) : this.s.type && this.s.type.includes("luxon") ? (a = this.c.conditions.luxon,
            this.s.dateFormat = this.s.type.replace(/luxon-/g, "")) : a = this.c.conditions.string;
            for (var d, l, u = 0, c = Object.keys(a); u < c.length; u++)
                null !== a[l = c[u]] && (e.page.info().serverSide && a[l].init === T.initSelect && (d = n[s],
                this.s.serverData && this.s.serverData[d.data] ? (a[l].init = T.initSelectSSP,
                a[l].inputValue = T.inputValueSelect,
                a[l].isInputValid = T.isInputValidSelect) : (a[l].init = T.initInput,
                a[l].inputValue = T.inputValueInput,
                a[l].isInputValid = T.isInputValidInput)),
                this.s.conditions[l] = a[l],
                "function" == typeof (I = a[l].conditionName) && (I = I(e, this.c.i18n)),
                t.push(B("<option>", {
                    text: I,
                    value: l
            ...
            for (var h = 0, p = Object.keys(this.s.conditions); h < p.length; h++) {
                l = p[h];
                var m = this.s.conditions[l].conditionName
                  , f = ("function" == typeof m && (m = m(e, this.c.i18n)),
                B("<option>", {
                    text: m,
                    value: l
                }).addClass(this.classes.option).addClass(this.classes.notItalic));
                void 0 !== this.s.condition && this.s.condition === m && (f.prop("selected", !0),
                this.dom.condition.removeClass(this.classes.italic)),
                t.push(f)
            }
        }
        for (var g = 0, v = t; g < v.length; g++)
            this.dom.condition.append(v[g]);
        if (n[s].searchBuilder && n[s].searchBuilder.defaultCondition) {
            var b = n[s].searchBuilder.defaultCondition;
            if ("number" == typeof b)
                this.dom.condition.prop("selectedIndex", b),
                this.dom.condition.trigger("change");
            else if ("string" == typeof b)
                for (var y = 0; y < t.length; y++)
                    for (var C = 0, V = Object.keys(this.s.conditions); C < V.length; C++) {
                        var I, w = V[C];
                        if (("string" == typeof (I = this.s.conditions[w].conditionName) ? I : I(e, this.c.i18n)) === t[y].text() && w === b) {
                            this.dom.condition.prop("selectedIndex", this.dom.condition.children().toArray().indexOf(t[y][0])).removeClass(this.classes.italic),
                            this.dom.condition.trigger("change"),
                            y = t.length;
                            break
                        }
    ...
    ,
    T.prototype._populateData = function() {
    ...
    ,
    T.prototype._populateValue = function(i) {
        ...
        this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, T.updateListener, void 0 !== i ? i.value : void 0)),
        void 0 !== i && void 0 !== i.value && (this.s.value = i.value),
        this.dom.inputCont.empty(),
        void 0 !== this.dom.value[0] && B(this.dom.value[0]).appendTo(this.dom.inputCont).trigger("dtsb-inserted"),
        t = 1; t < this.dom.value.length; t++)
            B(this.dom.value[t]).insertAfter(this.dom.value[t - 1]).trigger("dtsb-inserted");
    ...
    ,
    T.prototype._throttle = function(n, s) {
        var o = null
          , r = null
          , a = this;
    ...
    T.initSelect = function(e, t, n, i) {
        ...
        B("<select/>").addClass(T.classes.value).addClass(T.classes.dropDown).addClass(T.classes.italic).addClass(T.classes.select).append(e.dom.valueTitle).on("change.dtsb", function() {
            B(this).removeClass(T.classes.italic),
            t(e, this)
        })), d = (e.c.greyscale && a.addClass(T.classes.greyscale),
        []), l = [], u = 0, c = o; u < c.length; u++) {
            ...
            function(t, i) {
                ...
                a.removeClass(T.classes.italic),
    ...
    ,
    T.initSelectSSP = function(t, i, e) {
        void 0 === e && (e = null),
        t.dom.valueTitle.prop("selected", !0);
        for (var n = B("<select/>").addClass(T.classes.value).addClass(T.classes.dropDown).addClass(T.classes.italic).addClass(T.classes.select).append(t.dom.valueTitle).on("change.dtsb", function() {
            B(this).removeClass(T.classes.italic),
            i(t, this)
        }), s = (t.c.greyscale && n.addClass(T.classes.greyscale),
        []), o = 0, r = t.s.serverData[t.s.origData]; o < r.length; o++) {
            ...
            n.removeClass(T.classes.italic),
    ...
    ,
    T.initSelectArray = function(t, i, e) {
        return T.initSelect(t, i, e = void 0 === e ? null : e, !0)
    }
    ,
    T.initInput = function(i, e, t) {
        void 0 === t && (t = null);
        var n = i.s.dt.settings()[0].searchDelay
          , n = B("<input/>").addClass(T.classes.value).addClass(T.classes.input).on("input.dtsb keypress.dtsb", i._throttle(function(t) {
            t = t.keyCode || t.which;
            return e(i, this, t)
        }, null === n ? 100 : n));
        return i.c.greyscale && n.addClass(T.classes.greyscale),
        null !== t && n.val(t[0]),
    ...
    ,
    T.init2Input = function(i, e, t) {
        void 0 === t && (t = null);
        var n = i.s.dt.settings()[0].searchDelay
          , n = [B("<input/>").addClass(T.classes.value).addClass(T.classes.input).on("input.dtsb keypress.dtsb", i._throttle(function(t) {
            t = t.keyCode || t.which;
            return e(i, this, t)
        }, null === n ? 100 : n)), B("<span>").addClass(i.classes.joiner).html(i.s.dt.i18n("searchBuilder.valueJoiner", i.c.i18n.valueJoiner)), B("<input/>").addClass(T.classes.value).addClass(T.classes.input).on("input.dtsb keypress.dtsb", i._throttle(function(t) {
            t = t.keyCode || t.which;
            return e(i, this, t)
        }, null === n ? 100 : n))];
        return i.c.greyscale && (n[0].addClass(T.classes.greyscale),
        n[2].addClass(T.classes.greyscale)),
        null !== t && (n[0].val(t[0]),
        n[2].val(t[1])),
        i.s.dt.one("draw.dtsb", function() {
            i.s.topGroup.trigger("dtsb-redrawLogic")
    ...
    ,
    T.initDate = function(e, n, t) {
        void 0 === t && (t = null);
        var s = e.s.dt.settings()[0].searchDelay
          , i = e.s.dt.i18n("datetime", {})
          , i = B("<input/>").addClass(T.classes.value).addClass(T.classes.input).dtDateTime({
        ...
        return e.c.greyscale && i.addClass(T.classes.greyscale),
        null !== t && i.val(t[0]),
    ...
    ,
    T.init2Date = function(e, n, t) {
        var i = this
          , s = (void 0 === t && (t = null),
        e.s.dt.settings()[0].searchDelay)
          , o = e.s.dt.i18n("datetime", {})
          , o = [B("<input/>").addClass(T.classes.value).addClass(T.classes.input).dtDateTime({
            format: e.s.dateFormat || void 0,
            i18n: o
        }).on("change.dtsb", null !== s ? D.util.throttle(function() {
            return n(e, this)
        }, s) : function() {
            n(e, i)
        }
        ...
        }), B("<span>").addClass(e.classes.joiner).html(e.s.dt.i18n("searchBuilder.valueJoiner", e.c.i18n.valueJoiner)), B("<input/>").addClass(T.classes.value).addClass(T.classes.input).dtDateTime({
            format: e.s.dateFormat || void 0,
            i18n: o
        }).on("change.dtsb", null !== s ? D.util.throttle(function() {
            return n(e, this)
        ...
        return e.c.greyscale && (o[0].addClass(T.classes.greyscale),
        o[2].addClass(T.classes.greyscale)),
    ...
    ,
    T.isInputValidSelect = function(t) {
        for (var i = !0, e = 0, n = t; e < n.length; e++) {
            var s = n[e];
            s.children("option:selected").length === s.children("option").length - s.children("option." + T.classes.notItalic).length && 1 === s.children("option:selected").length && s.children("option:selected")[0] === s.children("option")[0] && (i = !1)
        }
        return i
    }
    ,
    T.isInputValidInput = function(t) {
        for (var i = !0, e = 0, n = t; e < n.length; e++) {
            var s = n[e];
    ...
    ,
    T.inputValueSelect = function(t) {
        for (var i = [], e = 0, n = t; e < n.length; e++) {
            var s = n[e];
            s.is("select") && i.push(T._escapeHTML(s.children("option:selected").data("sbv")))
        }
        return i
    }
    ,
    T.inputValueInput = function(t) {
        for (var i = [], e = 0, n = t; e < n.length; e++) {
            var s = n[e];
            s.is("input") && i.push(T._escapeHTML(s.val()))
        }
        return i.map(c.util.diacritics)
    }
    ,
    T.updateListener = function(t, i, e) {
    ...
    T.dateConditions = {
        "=": {
            ...
            init: T.initDate,
            inputValue: T.inputValueInput,
            isInputValid: T.isInputValidInput,
            search: function(t, i) {
    ...
    T.momentDateConditions = {
        "=": {
            ...
            search: function(t, i, e) {
                return m()(t, e.s.dateFormat).valueOf() === m()(i[0], e.s.dateFormat).valueOf()
            }
        },
        "!=": {
            conditionName: function(t, i) {
        ...
        between: {
            ...
            isInputValid: T.isInputValidInput,
            search: function(t, i, e) {
                var t = m()(t, e.s.dateFormat).valueOf()
    ...
    T.numConditions = {
        "=": {
            ...
            init: T.initSelect,
            inputValue: T.inputValueSelect,
            isInputValid: T.isInputValidSelect,
            search: function(t, i) {
                return +t == +i[0]
            }
        },
    ...
    T.defaults = {
        ...
        conditions: {
            ...
            date: T.dateConditions,
            html: T.stringConditions,
            "html-num": T.numConditions,
            "html-num-fmt": T.numFmtConditions,
            luxon: T.luxonDateConditions,
            moment: T.momentDateConditions,
            num: T.numConditions,
            "num-fmt": T.numFmtConditions,
            string: T.stringConditions
        },
        depthLimit: !1,
        enterSearch: !1,
    ...
    g.prototype.rebuild = function(t) {
        ...
        if (!(void 0 === t.criteria || null === t.criteria || Array.isArray(t.criteria) && 0 === t.criteria.length)) {
            ...
            for (var s = 0, o = this.s.criteria; s < o.length; s++)
                (i = o[s]).criteria instanceof d && (i.criteria.updateArrows(1 < this.s.criteria.length),
    ...
    g.prototype.redrawContents = function() {
        if (!this.s.preventRedraw) {
            ...
            for (var t = 0; t < this.s.criteria.length; t++) {
                ...
                i instanceof d ? (this.s.criteria[t].index = t,
    ...
    g.prototype.addCriteria = function(t) {
        for (var i = null === (t = void 0 === t ? null : t) ? this.s.criteria.length : t.s.index, e = new d(this.s.dt,this.s.opts,this.s.topGroup,i,this.s.depth,this.s.serverData,this.c.liveSearch), n = (null !== t && (e.c = t.c,
        e.s = t.s,
        ...
        for (var o = 0, r = this.s.criteria; o < r.length; o++) {
            var a = r[o];
            a.criteria instanceof d && a.criteria.updateArrows(1 < this.s.criteria.length)
        }
    ...
    g.prototype.checkFilled = function() {
        for (var t = 0, i = this.s.criteria; t < i.length; t++) {
            var e = i[t];
            if (e.criteria instanceof d && e.criteria.s.filled || e.criteria instanceof g && e.criteria.checkFilled())
                return !0
        }
        return !1
    }
    ...
    g.prototype._addPrevCriteria = function(t) {
        var i = this.s.criteria.length
          , e = new d(this.s.dt,this.s.opts,this.s.topGroup,i,this.s.depth,this.s.serverData);
        e.populate(),
        this.s.criteria.push({
            criteria: e,
            index: i
    ...
    g.prototype._andSearch = function(t, i) {
        if (0 !== this.s.criteria.length)
            for (var e = 0, n = this.s.criteria; e < n.length; e++) {
                var s = n[e];
                if ((!(s.criteria instanceof d) || s.criteria.s.filled) && !s.criteria.search(t, i))
                    return !1
            }
        return !0
    }
    ...
    g.prototype._setCriteriaListeners = function(n) {
        ...
        n.dom.delete.unbind("click").on("click.dtsb", function() {
            ...
            for (var t = 0, i = s.s.criteria; t < i.length; t++) {
                var e = i[t];
                e.criteria instanceof d && e.criteria.updateArrows(1 < s.s.criteria.length)
            }
            return n.destroy(),
            s.s.dt.draw(),
        ...
        n.dom.left.unbind("click").on("click.dtsb", function() {
            s.s.toDrop = new d(s.s.dt,s.s.opts,s.s.topGroup,n.s.index,void 0,s.s.serverData),
            s.s.toDrop.s = n.s,
            s.s.toDrop.c = n.c,
    ...
    ,
    n.prototype.rebuild = function(t, i) {
        return void 0 === i && (i = !0),
        this.dom.clearAll.trigger("click", !1),
    ...
    n.prototype._setUp = function(t) {
        var n = this;
        if (void 0 === t && (t = !0),
        "function" != typeof this.s.dt.column().type && D.Api.registerPlural("columns().types()", "column().type()", function() {
        ...
        !h.DateTime) {
            ...
            (void 0 === i || i.includes(void 0) || i.includes(null)) && (l.fn.dataTable.ext.oApi && l.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
        ...
        this.s.topGroup = new p(this.s.dt,this.c,void 0,void 0,void 0,void 0,this.s.serverData),
        this._setClearListener(),
    ...
    n.prototype._build = function() {
        ...
        l.fn.dataTable.ext.search.includes(this.s.search) || (this.s.search = function(t, i, e) {
        ...
        this.s.dt.on("destroy.dtsb", function() {
            ...
            for (var t = l.fn.dataTable.ext.search.indexOf(n.s.search); -1 !== t; )
                l.fn.dataTable.ext.search.splice(t, 1),
                t = l.fn.dataTable.ext.search.indexOf(n.s.search);
            n.s.dt.off(".dtsb"),
            l(n.s.dt.table().node()).off(".dtsb")
        })
    }
    ,
    ...
    n.prototype._setClearListener = function() {
        ...
        this.dom.clearAll.on("click.dtsb", function(t, i) {
            return e.s.topGroup = new p(e.s.dt,e.c,void 0,void 0,void 0,void 0,e.s.serverData),
            e._build(),
            !1 !== i && e.s.dt.draw(),
            e.s.topGroup.setListeners(),
            e.dom.clearAll.remove(),
            e._setEmptyListener(),
            e._filterChanged(0),
            !1
        })
    ...
    D.ext.buttons.searchBuilder = {
        ...
        init: function(i, t, e) {
            var n = this
              , s = new D.SearchBuilder(i,e.config);
            i.on("draw", function() {
    ...
    i("searchBuilder.rebuild()", function(t, i) {
        var e = this.context[0];
        return void 0 === e._searchBuilder ? null : (e._searchBuilder.rebuild(t, i = void 0 === i ? !0 : i),
        this)
    }),
    ...
    s(t).on("preInit.dt.dtsp", function(t, i) {
        "dt" !== t.namespace || !i.oInit.searchBuilder && !D.defaults.searchBuilder || i._searchBuilder || o(i)
    }),
    D.ext.feature.push({
        cFeature: "Q",
        fnInit: o
    }),
    D.feature && D.feature.register("searchBuilder", o),
    D
});
